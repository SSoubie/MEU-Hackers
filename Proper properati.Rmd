...
ggplot() +
  ...
  geom_sf(data=indice01, fill="hotpink4", alpha=0.75) +
...
2º Clculamos la cobertura de nuetras manzanas
...
ggplot()+
  geom_sf(data=manzanas, color="grey60") +
  geom_sf(data=hotelesI2, color="olivedrab4")+
