...
*Pusimos un sistema de coordenadas en dos planos*
...
```{r}
prueba <- filter(manzanacentroide, cobhospitales==TRUE & cobmetrobus==TRUE & cobsubte==TRUE & cobertura==TRUE & densidadPob>=16760)
```
