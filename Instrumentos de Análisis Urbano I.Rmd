...
ggplot()+
  ...
  geom_sf(data = manzanasindicesdetectAR, fill="blue", alpha=0.5)+
  geom_sf(data = manzanasindices, fill="red", alpha=0.5)+
  geom_sf(data = hotelesindicesdetectar, color="orange")+
  geom_sf(data=isocronosdetectarjuntospoligonos, fill="green", color="red", alpha=0.5)+
  theme_void()
```
