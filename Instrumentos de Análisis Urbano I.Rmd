...
```{r}
csac <- read_sf("https://raw.githubusercontent.com/SSoubie/MEU-Hackers/main/Datasets/centros_de_salud_nivel_1_BADATA_WGS84.geojson")
```

```{r}
cmb <- read_sf("https://raw.githubusercontent.com/SSoubie/MEU-Hackers/main/Datasets/centros-medicos-barriales.geojson")
```

```{r}
ess <- read_sf("https://raw.githubusercontent.com/SSoubie/MEU-Hackers/main/Datasets/estaciones-saludables.geojson")
```
