...
ggplot()+
  geom_sf(data=barriosCABA, aes (fill=""))+
...
ggplot() + 
  ...
  geom_sf(data=hoteles, aes(color="Hoteles"), show.legend= )+
  geom_sf(data=hospitales,aes(color="Hospitales"), show_legend= )+
  geom_sf(data=subte,aes(color="Subte"), show.legend= )+
  scale_color_manual(values= c("Hoteles"="olivedrab4","Hospitales"="salmon","Subte"="lightblue4", name="Referencias",
                    guide=guide_legend(override.aes=list(linetype="blank", shape=NA))))+
...
ggplot()+ 
  ...
  geom_sf(data = manzanacentroide, aes (color = "Centroide de Manzana"), show.legend=)+
  geom_sf(data = avenidas, aes (color = "Avenidas"), show.legend =)+
  geom_sf(data = subte, aes(color = "Subte", show.legend="point"))+
  geom_sf(data = metrobus, aes (color = "Metrobus)", show.legend="point"))+
  scale_colour_manual(values = c("NA"= "white", "Centroide de Manzana" = "grey60", "Avenidas"="hotpink4", "Subte"="olivedrab4", "Metrobus"="salmon"),name = NULL,
                    guide = guide_legend(override.aes = list(linetype = "blank", shape = NA))) +
...
ggplot()+
  ...
  ##labs(title = "Manzanas ideales", 
      ## subtitle= "Según cercanía a avenidas y las paradas de metrobus y estaciones de subte",
      ## caption = "Fuente: BA DATA")+
  theme_void()
```
...
```{r fig.height=10, fig.width=10}
ggplot()+
  geom_sf(data = manzanas, fill="NA",show.legend = TRUE)+
  geom_sf(data = filter(manzanacentroide, cobhospitales=="TRUE" & cobcesac=="TRUE"), color="lightblue2",show.legend = TRUE)+
  labs(title = "Manzanas ideales", 
...
```{r fig.height=10, fig.width=10}
ggplot()+
  geom_sf(data=manzanas, fill="NA", color="grey") +
  geom_sf(data=indice01, fill="blue", alpha=0.5)+
  geom_sf(data=indice02, fill = "red", alpha=0.5)+
  theme_void()
```
...
ggplot()+
  geom_sf(data=manzanas, fill="NA", color="grey") +
  geom_sf(data=hotelesI1, color="blue", alpha=0.5, size=3)+
  geom_sf(data=hotelesI2, color = "red", alpha=0.5, size=3)+
  theme_void()
```
...
ggplot()+
  geom_sf(data=manzanas, fill="NA", color="grey") +
  geom_sf(data=manzanasindices, fill="lightblue3")+
  geom_sf(data=hotelesindices, color = "hotpink4")+
  theme_void()
```
